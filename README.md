...
- `analysis/` — `08_measurement.ipynb` (**living**) · `07_demoted_in_favor_of_5D.ipynb` (**frozen record**) · `validate_rising_terminal.py` · `archive/` (NB00–06). Guide: `analysis/README.md`.
...
- `legacy/` — the original team's code/data (untracked) + our superseded frozen table builders (`legacy/scripts/`, tracked, replication-only).

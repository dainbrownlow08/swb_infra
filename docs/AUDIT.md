...
3. ✅ **Degenerate features**: personal focus → pooled raw hits (per-utterance score Deprecated); rising terminal → word-anchored tail, missingness preserved (never fillna(0)), **semitone threshold 2026-07-29**. The sole remaining NaN→0 lives in the bannered frozen `legacy/scripts/build_merge_test.py`.
